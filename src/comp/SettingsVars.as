package comp
{
	...
	public class SettingsVars
	{
		...
		public function SettingsVars(use_xampp:Boolean=false,chat_autostart:Boolean=false,country_name:String='Poland',bsurl:String='disabled',nick:String='anonym',email:String='',pass:String='',active_battles_max_height:int=500, main_window_max_height:int=500,default_refresh_rate:int=60,userID:int=0)
		{
